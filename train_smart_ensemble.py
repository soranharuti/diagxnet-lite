...
def train_inception_resnet_v2(train_loader, val_loader, class_weights, device, num_epochs=5, lr=1e-4):
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            }, 'models/inception_resnet_v2_best.pth')
...
def main():
    ...
    parser.add_argument('--model1-path', default='models/densenet121_chexpert_20250906_195712_best.pth')
    ...
    print("="*70)
    print("\nSaved models:")
    print("  ✓ models/inception_resnet_v2_best.pth")
    print("  ✓ models/ensemble_best.pth")
